...
namespace ConsoleToDoApp
{
    public class TodoLine : IApp
    {
        ...
        public void AddCard(int CardId)
        {
            ...
            Console.WriteLine("Kartınız TodoLine'a başarıyla eklendi");
        }
        ...
        public void RemoveCard(int CardId)
        {
            ...
            Console.WriteLine("Todo Line'da Silme işlemi başarılı");
        }
